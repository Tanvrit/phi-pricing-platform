 ...
 *       user = AegisUser("Vivek", "VS"),
 *       onSearchClick = {},
 *   )
 *
 * Slots:
 *   • breadcrumbs — list of crumbs (clickable if `onClick` provided).
 *   • search — placeholder search affordance (real command palette ships Ship-2).
        ...
        Row(
            ...
            breadcrumbs.forEachIndexed { idx, crumb ->
                ...
                val style = AegisTypography.body.copy(
                    color = color,
                    fontWeight = if (isLast) androidx.compose.ui.text.font.FontWeight.SemiBold
