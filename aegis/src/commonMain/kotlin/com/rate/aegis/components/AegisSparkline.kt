 ...
 *
 * No axes, labels, dots, or hover interactivity — this is a pure visual hint
 * showing the shape of the last-N-buckets trend so an operator can scan the
 * KPI strip and see at a glance whether things are climbing, sliding, or flat.
 *
