...
import com.rate.sdk.ui.buyonline.platform.copyToClipboard
...
import com.rate.sdk.ui.kit.brand.PruSuccess
...
fun ResumeBanner(
    ...
    onEmailResumeLink: suspend (email: String, url: String) -> Boolean = { _, _ -> false },
) {
    ...
    EmailResumeDialog(
        ...
        onEmailResumeLink = onEmailResumeLink,
...
private fun EmailResumeDialog(
    open: Boolean,
    resumeUrl: String,
    onEmailResumeLink: suspend (email: String, url: String) -> Boolean,
    onDismiss: () -> Unit,
        ...
        confirmButton = {
            Button(
                onClick = {
                    ...
                    sending = true
                    scope.launch {
                        val ok = onEmailResumeLink(email, resumeUrl)
                        sending = false
                        onResult(
